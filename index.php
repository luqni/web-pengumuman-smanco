...
<body>
    ...
    <div class="container">
		...
		?>
			...
			<?php
			if( $data['status'] == 1 ){
				echo '<div class="alert alert-success" role="alert"><strong>SELAMAT !</strong> Anda dinyatakan LULUS / <del>TIDAK LULUS</del>.</div>';
			} else {
				echo '<div class="alert alert-danger" role="alert"><strong>MAAF !</strong> Anda dinyatakan TIDAK LULUS / <del> LULUS </del>.</div>';
			}	
			?>
			<div class="center">
