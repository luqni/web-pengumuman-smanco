...
while ($row = mysqli_fetch_array($hasil)){
    ...
    $pdf->Cell(110,4,'Pendidikan Agama dan Budi Pekerti',1,0);
    $pdf->Cell(40,4,$row['n_uas_pai_a'],1,1, 'C');
    $pdf->Cell(10,4,'2',1,0, 'C');
    $pdf->Cell(110,4,'Pendidikan Pancasila dan Kewarganegaraan',1,0);
    $pdf->Cell(40,4,$row['n_uas_pkn_a'],1,1, 'C');
    $pdf->Cell(10,4,'3',1,0, 'C');
    $pdf->Cell(110,4,'Bahasa Indonesia',1,0);
    $pdf->Cell(40,4,$row['n_uas_bindonesia_a'],1,1, 'C');
    $pdf->Cell(10,4,'4',1,0, 'C');
    $pdf->Cell(110,4,'Matematika',1,0);
    $pdf->Cell(40,4,$row['n_uas_matematika_a'],1,1, 'C');
    $pdf->Cell(10,4,'5',1,0, 'C');
    $pdf->Cell(110,4,'Sejarah Indonesia',1,0);
    $pdf->Cell(40,4,$row['n_uas_sejarah_a'],1,1, 'C');
    $pdf->Cell(10,4,'6',1,0, 'C');
    $pdf->Cell(110,4,'Bahasa Inggris',1,0);
    $pdf->Cell(40,4,$row['n_uas_binggris_a'],1,1, 'C');

    $pdf->SetFont('times','B',8); 
    $pdf->Cell(160,4,'Kelompok B',1,1);
    $pdf->SetFont('times','',8);
    $pdf->Cell(10,4,'1',1,0, 'C');
    $pdf->Cell(110,4,'Seni Budaya',1,0);
    $pdf->Cell(40,4,$row['n_uas_seni_b'],1,1, 'C');
    $pdf->Cell(10,4,'2',1,0, 'C');
    $pdf->Cell(110,4,'Pendidikan Jasmani, Olahraga dan Kesehatan',1,0);
    $pdf->Cell(40,4,$row['n_uas_penjas_b'],1,1, 'C');
    $pdf->Cell(10,4,'3',1,0, 'C');
    $pdf->Cell(110,4,'Prakarya dan Kewirausahaan',1,0);
    $pdf->Cell(40,4,$row['n_uas_prakarya_b'],1,1, 'C');
    $pdf->Cell(10,4,'4',1,0, 'C');
    $pdf->Cell(150,4,'Muatan Lokal',1,1);
    $pdf->Cell(10,4,'',1,0, 'C');
    $pdf->Cell(110,4,'a. Bahasa Jawa',1,0);
    $pdf->Cell(40,4,$row['n_uas_bjawa_b'],1,1, 'C');
    ...
    while ($row = mysqli_fetch_array($hasil)){
        if($row['deskripsi_jurusan'] == 'PEMINATAN MATEMATIKA DAN ILMU PENGETAHUAN ALAM'){
            $pdf->Cell(10,4,'1',1,0, 'C');
            $pdf->Cell(110,4,'Matematika',1,0);
            $pdf->Cell(40,4,$row['n_uas_matematika_c'],1,1, 'C');
            $pdf->Cell(10,4,'2',1,0, 'C');
            $pdf->Cell(110,4,'Biologi',1,0);
            $pdf->Cell(40,4,$row['n_uas_biologi_c'],1,1, 'C');
            $pdf->Cell(10,4,'3',1,0, 'C');
            $pdf->Cell(110,4,'Fisika',1,0);
            $pdf->Cell(40,4,$row['n_uas_fisika_c'],1,1, 'C');
            $pdf->Cell(10,4,'4',1,0, 'C');
            $pdf->Cell(110,4,'Kimia',1,0);
            $pdf->Cell(40,4,$row['n_uas_kimia_c'],1,1, 'C');
            $pdf->Cell(10,4,'5',1,0, 'C');
            $pdf->Cell(150,4,'Pilihan Lintas Minat / Pendalaman Minat',1,1);
            $pdf->Cell(10,4,'',1,0, 'C');
            if($row['jurusan'] == 'MIPA 5' && 'MIPA 6'){
                $pdf->Cell(110,4,'Sastra Inggris',1,0);
            ...
            $pdf->Cell(40,4,$row['n_uas_matematika_c'],1,1, 'C');
            $pdf->Cell(10,4,'2',1,0, 'C');
            $pdf->Cell(110,4,'Sejarah',1,0);
            $pdf->Cell(40,4,$row['n_uas_biologi_a'],1,1, 'C');
            $pdf->Cell(10,4,'3',1,0, 'C');
            $pdf->Cell(110,4,'Sosiologi',1,0);
            $pdf->Cell(40,4,$row['n_uas_fisika_c'],1,1, 'C');
            $pdf->Cell(10,4,'4',1,0, 'C');
            $pdf->Cell(110,4,'Ekonomi',1,0);
            $pdf->Cell(40,4,$row['n_uas_kimia_c'],1,1, 'C');
            $pdf->Cell(10,4,'5',1,0, 'C');
            $pdf->Cell(165,4,'Pilihan Lintas Minat / Pendalaman Minat',1,1);
            $pdf->Cell(10,4,'',1,0, 'C');
            $pdf->Cell(110,4,'Sastra Inggris',1,0);
            $pdf->Cell(40,4,$row['n_uas_minat_c'],1,1, 'C');
        }else{
            $pdf->Cell(10,4,'1',1,0, 'C');
            $pdf->Cell(110,4,'Bahasa dan Satra indonesia',1,0);
            $pdf->Cell(40,4,$row['n_uas_matematika_c'],1,1, 'C');
            $pdf->Cell(10,4,'2',1,0, 'C');
            $pdf->Cell(110,4,'Bahasa dan sastra inggis',1,0);
            $pdf->Cell(40,4,$row['n_uas_biologi_c'],1,1, 'C');
            $pdf->Cell(10,4,'3',1,0, 'C');
            $pdf->Cell(110,4,'Bahasa dan sastra perancis',1,0);
            $pdf->Cell(40,4,$row['n_uas_fisika_c'],1,1, 'C');
            $pdf->Cell(10,4,'4',1,0, 'C');
            $pdf->Cell(110,4,'Antropologo',1,0);
            $pdf->Cell(40,4,$row['n_uas_kimia_c'],1,1, 'C');
            $pdf->Cell(10,4,'5',1,0, 'C');
            $pdf->Cell(165,4,'Pilihan Lintas Minat / Pendalaman Minat',1,1);
            $pdf->Cell(10,5,'',1,0, 'C');
            $pdf->Cell(110,5,'Biologi',1,0);
            $pdf->Cell(40,4,$row['n_uas_minat_c'],1,1, 'C');
        }

        $pdf->SetFont('times','B',8);
        $pdf->Cell(120,4,'Rata-rata',1,0,'C');
        $pdf->Cell(40,4,$row['rata_rata_uas'],1,1, 'C');
    }
    $pdf->Cell(27,2,'',0,1);
    $pdf->SetFont('times','',8);
    ...
    $pdf->Cell(100,3,'',0,0);
    $pdf->Cell(28,3,'Kepala Sekolah,',0,1);
    $pdf->Image('images/tanda_tangan.jpeg',115,210,25,25);
    $no_ujian = $_REQUEST['id'];
    $hasil = mysqli_query($db_conn,"SELECT username FROM data_siswa WHERE no_ujian='$no_ujian'");
    while ($row = mysqli_fetch_array($hasil)){
        $path = 'images/foto-hitamputih/';
        $filename = $row['username'].'.jpg';
        $filepath = $path.$filename;
